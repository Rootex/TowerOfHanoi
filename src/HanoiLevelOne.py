# This game is an experimental implemetation of
...
# sign between developer and second party.
#
# For contact reasons:
...
class HanoiLevelOne:
    ...
    def game_loop(self):
        ...
        while True:
            try:
                origin = int(input("Input Origin(1, 2, 3): "))
                destination = int(input("Input Destination(1, 2, 3): "))
